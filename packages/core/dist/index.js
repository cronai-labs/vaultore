...
function runCommand(command, args, stdin, timeoutMs = 0) {
  return new Promise((resolve, reject) => {
    ...
    const child = child_process.spawn(resolvedCommand, args, { stdio: "pipe" });
    let stdout = "";
    let stderr = "";
    let timeout;
    if (stdin) {
...
exports.DEFAULT_GO_CONFIG = DEFAULT_GO_CONFIG;
...
exports.WorkflowFrontmatterSchema = WorkflowFrontmatterSchema;
